...
3. `docs/contributing/ENV-AND-SECRETS.md` (env hygiene)
4. `docs/contributing/CHANGE-TYPES-DECISION-MATRIX.md` (required tests per change)
5. `docs/contributing/BACKEND-TESTING.md` (API/workers/connectors/domain)
6. `docs/contributing/FRONTEND-TESTING.md` (web app)
7. `docs/contributing/PLAYWRIGHT-E2E.md` (E2E rules)
8. `docs/contributing/QUALITY-GATES.md` (CI gates + stop-ship)
...
- Env + secrets: `docs/contributing/ENV-AND-SECRETS.md`
