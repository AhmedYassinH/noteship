...
- Frontend structure, editor, i18n: docs/technical/detailed/08-frontend-architecture.md
- API contracts for UI calls: docs/technical/detailed/11-api-design-and-contracts.md
- MVP scope boundaries: docs/technical/detailed/03-mvp-scope-and-feature-definition.md
- Functional requirements: docs/technical/detailed/05-functional-requirements.md
