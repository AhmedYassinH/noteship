...
export const userSchema = z.object({
  ...
  subscriptionId: nonEmptyStringSchema.optional(),
  priceId: nonEmptyStringSchema.optional(),
  notesUsed: z.number().int().nonnegative().optional(),
  activeScheduledPosts: z.number().int().nonnegative().optional(),
  storageUsedMb: z.number().nonnegative().optional(),
  storageReservedMb: z.number().nonnegative().optional(),
  storageAccountedMb: z.number().nonnegative().optional(),
