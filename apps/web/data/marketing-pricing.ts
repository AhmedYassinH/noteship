...
const pricingCopy: Record<Lang, PricingCopy> = {
  ...
  ar: {
    ...
    heroSub: "ابدأ مجاناً، ثم رقِّ للجدولة وحدود أعلى للذكاء الاصطناعي عندما تكون جاهزاً.",
    ...
    finalCopy: "ابدأ مجاناً ثم رقِّ عندما تصبح الجدولة ضرورية.",
    finalPrimary: "ابدأ مجاناً",
    finalSecondary: "عرض المزايا",
  },
};
