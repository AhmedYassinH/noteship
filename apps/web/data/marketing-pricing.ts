  ...
  en: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. LinkedIn is available now, and integration coverage will keep growing.",
      },
    ],
    finalTitle: "Turn your notes into consistent publishing",
    finalCopy: "Start free and build a publishing workflow from your own notes.",
  ...
  ar: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "نعم. LinkedIn متاح حاليًا، والتكاملات ستتوسع تدريجيًا.",
      },
    ],
